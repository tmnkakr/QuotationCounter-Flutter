...
import 'package:flutter_application_1/add_orig_poly.dart';

class AddTextFieldPage extends StatefulWidget {
  const AddTextFieldPage({Key? key}) : super(key: key);
...
class _AddTextFieldPageState extends State<AddTextFieldPage> {
  ...
  void _navigateToNextScreen() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => const AddAdditionalPoly(),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Add Additional Poly'),
      ),
      body: Padding(
